// Script para generar datos de prueba para la aplicación de gastos (versión corregida)
// Este script:
    ...
    try {
      await prisma.gasto.create({
        data: {
          ...
          tipoTransaccion: 'ingreso',  // Cambiado de tipo a tipoTransaccion
          tipoMovimiento: 'ingreso',   // Agregado tipoMovimiento
        ...
        try {
          await prisma.gasto.create({
            data: {
              ...
              fecha: randomDateInMonth(año, mes),
              tipoTransaccion: 'gasto',  // Cambiado de tipo a tipoTransaccion
              tipoMovimiento: 'gasto',   // Agregado tipoMovimiento
