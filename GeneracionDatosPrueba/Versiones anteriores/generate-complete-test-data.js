...
async function generateCompleteTestData() {
  console.log('=== INICIO DE GENERACIÓN DE DATOS DE PRUEBA COMPLETOS ===');
  ...
  try {
    ...
    // 8. GENERAR TRANSACCIONES PARA CADA PERIODO
    ...
    console.log(`Se han generado datos realistas para los últimos 6 meses (${periodos.map(p => `${p.mes}/${p.año}`).join(', ')})`);
